...
import { VarianceContextCard, SupplierPerformanceModule, LiveCommandPanel } from '@/components/director-enhancements'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.section variants={sectionVariants}>
          <div className="flex items-center justify-between mb-5">
            ...
            >
              ...
              <div>
                <h3 className="text-sm sm:text-base font-semibold text-foreground">Portfolio Health</h3>
        ...
        {/* ─── REGION 2: Live Portfolio Command Panel ─── */}
        <motion.section variants={sectionVariants}>
          <LiveCommandPanel />
        </motion.section>

        {/* ─── REGION 3: Variance Context ─── */}
        <motion.section variants={sectionVariants}>
          <VarianceContextCard />
        </motion.section>

        {/* ─── REGION 4: Portfolio Heatmap ─── */}
        <motion.section variants={sectionVariants}>
          <PortfolioHeatmap />
        </motion.section>

        {/* ─── REGION 5: Supplier Performance ─── */}
        <motion.section variants={sectionVariants}>
        ...
        {/* ─── REGION 7: Key Person Risk + Awaiting Approval ─── */}
        <motion.section
