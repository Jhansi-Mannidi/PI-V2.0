...
export const CONTROLS: Control[] = [
  ...
  },
  {
    ...
    ownerId: 'USR-004', ownerName: 'Sophia Lam',
...
export const CONTROLS_AUDIT_OCCURRENCES: AuditOccurrence[] = [
  // AO-1201: Completed — Monthly Financial (Henderson/Pryor Creek)
  {
    ...
    findings: [
      { id: 'FND-001', occurrenceId: 'AO-1201', severity: 'Medium', description: '2 change orders on Pryor Creek (CO-447, CO-451) processed without independent cost review attestation.', remediationOwnerId: 'USR-004', remediationOwnerName: 'Sophia Lam', dueDate: '2026-06-15', status: 'Closed', linkedItemId: 'CTL-004' },
    ],
    trailEntries: [
...
export const COMPLIANCE_ITEMS: ComplianceItem[] = [
  ...
  { id: 'CMP-013', requirement: 'SOX Financial Close Sign-Off — Q1 2026 — All Projects', framework: 'SOX', project: 'PRJ-001', projectName: 'Henderson Substation', ownerId: 'USR-004', ownerName: 'Sophia Lam', evidence: 'SOX-Q1-Financial-Close.pdf', expiryDate: null, daysToExpiry: null, status: 'Compliant', lastVerified: '2026-04-30' },
...
export const COMPLIANCE_AUDIT_SCHEDULES: AuditSchedule[] = [
  ...
  },
  {
    ...
    assignedAuditorId: 'USR-007', assignedAuditorName: 'Daniel Cho',
    accountableOwnerId: 'USR-004', accountableOwnerName: 'Sophia Lam',
