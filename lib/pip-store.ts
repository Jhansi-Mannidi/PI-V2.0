  ...
  const slaBreaches: SLABreachRecord[] = [
    {
      ...
      uploadedById: 'USR-004', uploadedByName: 'Sophia Lamb',
    ...
    },
    {
      ...
      reviewedById: 'USR-002', reviewedByName: 'Anu Reddi',
      status: 'open', notes: 'Legal review flagged as bottleneck. Awaiting sign-off.',
      affectedParties: ['Lena Ortiz', 'Anu Reddi', 'Legal Team'],
    },
  ]
  ...
  const controlTestRuns: ControlTestRun[] = [
    {
      ...
      testedById: 'USR-004', testedByName: 'Sophia Lamb',
      reviewedById: 'USR-003', reviewedByName: 'Hasit Chetal',
      result: 'PASS', score: 97, notes: 'All thresholds within policy bounds.',
      affectedRiskIds: [], affectedParties: ['Sophia Lamb', 'ODC Controls'],
    },
    {
  ...
  const activityLog: ActivityEvent[] = [
    {
      ...
      affectedParties: ['ELS Legal', 'EMEA Program Team', 'Anu Reddi'],
      previousValue: 'Mitigating', newValue: 'Escalated',
    },
    {
      id: 'ACT-002', kind: 'CONTROL_TESTED', at: Date.now() - 1000 * 60 * 30,
      actorId: 'USR-004', actorName: 'Sophia Lamb', actorRole: 'Control Owner',
    ...
    },
    {
      ...
      affectedParties: ['Alice Cox', 'NA-West Team', 'Anu Reddi'],
    },
    {
